...
{
    $sqlinsert = "INSERT INTO `voting` (`uid`,`tid`,`downvoted`) VALUES (".$_SESSION['id'].",".$tid.",1)";
    ...
    {
        $sqlinsert = "UPDATE `voting` SET `downvoted`=1 WHERE tid=".$tid." AND uid=".$_SESSION['id']."";
        $sqlGetVote = "SELECT vote FROM thread WHERE tid=".$tid.";";
        if($conn->query($sqlinsert))
    {
        $resultGetVote = $conn->query($sqlGetVote);
    ...
    {
        $sqlinsert = "UPDATE `voting` SET `downvoted`=0 WHERE tid=".$tid." AND uid=".$_SESSION['id']."";
        $sqlGetVote = "SELECT vote FROM thread WHERE tid=".$tid.";";
    ...
    {
        $sqlinsert = "UPDATE `voting` SET `upvoted`=0, `downvoted`=1 WHERE tid=".$tid." AND uid=".$_SESSION['id']."";
        $sqlGetVote = "SELECT vote FROM thread WHERE tid=".$tid.";";
